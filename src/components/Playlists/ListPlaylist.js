...
import userData from '../../mockData/userPlaylists.json'; // Adjust the path as needed

const UserPlaylists = ({ playlists = userData.data.userPlaylists, accessToken, deviceId }) => {
